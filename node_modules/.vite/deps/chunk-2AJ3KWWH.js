...
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 1)
        hierarchicalobject_changes.object = ctx2[0];
      if (dirty & 1)
        hierarchicalobject_changes.onChildMount = ctx2[2];
      if (dirty & 1)
        hierarchicalobject_changes.onChildDestroy = ctx2[3];
      if (dirty & 16) {
...
function add_css(target) {
  append_styles(target, "svelte-o3oskp", "canvas.svelte-o3oskp{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQ2FudmFzLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUF5RkUsTUFBQSxjQUFBLENBQUEsQUFDRSxPQUFBLENBQUEsS0FBYyxBQUNoQixDQUFBIiwibmFtZXMiOltdLCJzb3VyY2VzIjpbIkNhbnZhcy5zdmVsdGUiXX0= */");
}
...
function create_fragment3(ctx) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          action_destroyer(parentSizeAction_action = ctx[3].call(null, canvas_1)),
          listen_dev(canvas_1, "click", ctx[9], false, false, false),
          listen_dev(canvas_1, "contextmenu", ctx[10], false, false, false),
          listen_dev(canvas_1, "pointerup", ctx[13], false, false, false),
          listen_dev(canvas_1, "pointerdown", ctx[11], false, false, false),
          listen_dev(canvas_1, "pointermove", ctx[12], false, false, false),
          listen_dev(canvas_1, "pointerenter", ctx[31], false, false, false),
          listen_dev(canvas_1, "pointerleave", ctx[32], false, false, false)
        ];
        mounted = true;
      }
    },
...
function create_default_slot3(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const scenegraphobject_changes = {};
      if (dirty & 2)
        scenegraphobject_changes.object = ctx2[1];
      if (dirty & 262144) {
        scenegraphobject_changes.$$scope = { dirty, ctx: ctx2 };
      }
      scenegraphobject.$set(scenegraphobject_changes);
...
function create_fragment8(ctx) {
  ...
  if (ctx[0] !== void 0) {
    viewportawareobject_props.inViewport = ctx[0];
  }
  viewportawareobject = new ViewportAwareObject_default({
    props: viewportawareobject_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(viewportawareobject, "inViewport", viewportawareobject_inViewport_binding, ctx[0]));
  viewportawareobject.$on("viewportenter", ctx[16]);
  viewportawareobject.$on("viewportleave", ctx[17]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 2)
        layerableobject_changes.object = ctx2[1];
      layerableobject.$set(layerableobject_changes);
      const transformableobject_changes = {};
      if (dirty & 2)
        transformableobject_changes.object = ctx2[1];
      if (dirty & 4)
        transformableobject_changes.position = ctx2[2];
      if (dirty & 16)
        transformableobject_changes.rotation = ctx2[4];
      if (dirty & 8)
        transformableobject_changes.scale = ctx2[3];
      if (dirty & 32)
        transformableobject_changes.lookAt = ctx2[5];
      transformableobject.$set(transformableobject_changes);
      const disposableobject_changes = {};
      if (dirty & 2)
        disposableobject_changes.object = ctx2[1];
      if (dirty & 128)
        disposableobject_changes.dispose = ctx2[7];
      if (dirty & 262146) {
      ...
      if (dirty & 2)
        viewportawareobject_changes.object = ctx2[1];
      if (dirty & 64)
        viewportawareobject_changes.viewportAware = ctx2[6];
      if (!updating_inViewport && dirty & 1) {
        updating_inViewport = true;
        viewportawareobject_changes.inViewport = ctx2[0];
...
function create_fragment9(ctx) {
  ...
  if (ctx[0] !== void 0) {
    object3dinstance_props.inViewport = ctx[0];
  }
  object3dinstance = new Object3DInstance_default({
    props: object3dinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(object3dinstance, "inViewport", object3dinstance_inViewport_binding, ctx[0]));
  object3dinstance.$on("viewportenter", ctx[19]);
  object3dinstance.$on("viewportleave", ctx[20]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 2)
        object3dinstance_changes.object = ctx2[1];
      if (dirty & 32)
        object3dinstance_changes.lookAt = ctx2[5];
      if (dirty & 128)
        object3dinstance_changes.castShadow = ctx2[7];
      if (dirty & 256)
        object3dinstance_changes.receiveShadow = ctx2[8];
      if (dirty & 512)
        object3dinstance_changes.frustumCulled = ctx2[9];
      if (dirty & 1024)
        object3dinstance_changes.renderOrder = ctx2[10];
      if (dirty & 4)
        object3dinstance_changes.position = ctx2[2];
      if (dirty & 8)
        object3dinstance_changes.scale = ctx2[3];
      if (dirty & 16)
        object3dinstance_changes.rotation = ctx2[4];
      if (dirty & 64)
        object3dinstance_changes.viewportAware = ctx2[6];
      if (dirty & 2048)
        object3dinstance_changes.visible = ctx2[11];
      if (dirty & 4096)
        object3dinstance_changes.userData = ctx2[12];
      if (dirty & 8192)
      ...
      if (!updating_inViewport && dirty & 1) {
        updating_inViewport = true;
        object3dinstance_changes.inViewport = ctx2[0];
        add_flush_callback(() => updating_inViewport = false);
      }
...
function create_fragment10(ctx) {
  ...
  if (ctx[1] !== void 0) {
    camerainstance_props.inViewport = ctx[1];
  }
  camerainstance = new CameraInstance_default({
    props: camerainstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(camerainstance, "inViewport", camerainstance_inViewport_binding, ctx[1]));
  camerainstance.$on("viewportenter", ctx[26]);
  camerainstance.$on("viewportleave", ctx[27]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 1)
        camerainstance_changes.camera = ctx2[0];
      if (dirty & 4)
        camerainstance_changes.position = ctx2[2];
      if (dirty & 8)
        camerainstance_changes.scale = ctx2[3];
      if (dirty & 16)
        camerainstance_changes.rotation = ctx2[4];
      if (dirty & 128)
        camerainstance_changes.castShadow = ctx2[7];
      if (dirty & 256)
        camerainstance_changes.receiveShadow = ctx2[8];
      if (dirty & 512)
        camerainstance_changes.frustumCulled = ctx2[9];
      if (dirty & 1024)
        camerainstance_changes.renderOrder = ctx2[10];
      if (dirty & 2048)
        camerainstance_changes.visible = ctx2[11];
      if (dirty & 4096)
        camerainstance_changes.userData = ctx2[12];
      if (dirty & 8192)
        camerainstance_changes.dispose = ctx2[13];
      if (dirty & 64)
        camerainstance_changes.viewportAware = ctx2[6];
      if (dirty & 32)
        camerainstance_changes.lookAt = ctx2[5];
      if (dirty & 16384)
        camerainstance_changes.useCamera = ctx2[14];
      if (dirty & 268435456) {
        camerainstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty & 2) {
        updating_inViewport = true;
        camerainstance_changes.inViewport = ctx2[1];
        add_flush_callback(() => updating_inViewport = false);
      }
...
function create_fragment11(ctx) {
  ...
  binding_callbacks.push(() => bind(camerainstance, "inViewport", camerainstance_inViewport_binding, ctx[1]));
  camerainstance.$on("viewportenter", ctx[22]);
  camerainstance.$on("viewportleave", ctx[23]);
  const block = {
    c: function create() {
      create_component(camerainstance.$$.fragment);
    },
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 16)
        camerainstance_changes.rotation = ctx2[4];
      if (dirty & 64)
        camerainstance_changes.castShadow = ctx2[6];
      if (dirty & 128)
        camerainstance_changes.receiveShadow = ctx2[7];
      if (dirty & 256)
        camerainstance_changes.frustumCulled = ctx2[8];
      if (dirty & 512)
        camerainstance_changes.renderOrder = ctx2[9];
      if (dirty & 1024)
        camerainstance_changes.visible = ctx2[10];
      if (dirty & 2048)
        camerainstance_changes.userData = ctx2[11];
      if (dirty & 4096)
        camerainstance_changes.dispose = ctx2[12];
      if (dirty & 8192)
        camerainstance_changes.viewportAware = ctx2[13];
      if (dirty & 32)
        camerainstance_changes.lookAt = ctx2[5];
      if (dirty & 16384)
        camerainstance_changes.useCamera = ctx2[14];
...
function create_fragment12(ctx) {
  ...
  binding_callbacks.push(() => bind(object3dinstance, "inViewport", object3dinstance_inViewport_binding, ctx[0]));
  object3dinstance.$on("viewportenter", ctx[20]);
  object3dinstance.$on("viewportleave", ctx[21]);
  const block = {
    c: function create() {
      create_component(object3dinstance.$$.fragment);
    },
    ...
    p: function update(ctx2, [dirty]) {
      const object3dinstance_changes = {};
      if (dirty & 2)
        object3dinstance_changes.position = ctx2[1];
      if (dirty & 4)
        object3dinstance_changes.scale = ctx2[2];
      if (dirty & 8)
        object3dinstance_changes.rotation = ctx2[3];
      if (dirty & 16)
        object3dinstance_changes.lookAt = ctx2[4];
      if (dirty & 256)
        object3dinstance_changes.frustumCulled = ctx2[8];
      if (dirty & 512)
        object3dinstance_changes.renderOrder = ctx2[9];
      if (dirty & 1024)
        object3dinstance_changes.visible = ctx2[10];
      if (dirty & 2048)
        object3dinstance_changes.userData = ctx2[11];
      if (dirty & 4096)
        object3dinstance_changes.dispose = ctx2[12];
      if (dirty & 64)
        object3dinstance_changes.castShadow = ctx2[6];
      if (dirty & 128)
        object3dinstance_changes.receiveShadow = ctx2[7];
      if (dirty & 32)
        object3dinstance_changes.viewportAware = ctx2[5];
      if (dirty & 4194304) {
        object3dinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty & 1) {
...
function create_fragment13(ctx) {
  ...
  object3dinstance.$on("viewportenter", ctx[27]);
  object3dinstance.$on("viewportleave", ctx[28]);
  const block = {
    c: function create() {
      create_component(object3dinstance.$$.fragment);
    },
...
function create_fragment14(ctx) {
  ...
  let audioinstance_props = {
    ...
    rotation: ctx[6],
    lookAt: ctx[7],
    frustumCulled: ctx[11],
    renderOrder: ctx[12],
    visible: ctx[13],
    userData: ctx[14],
    dispose: ctx[15],
    castShadow: ctx[9],
    receiveShadow: ctx[10],
    viewportAware: ctx[8],
    autoplay: ctx[16],
    source: ctx[18],
    detune: ctx[17],
  ...
  if (ctx[0] !== void 0) {
    audioinstance_props.inViewport = ctx[0];
  }
  if (ctx[1] !== void 0) {
    audioinstance_props.play = ctx[1];
  }
  if (ctx[2] !== void 0) {
    audioinstance_props.pause = ctx[2];
  }
  if (ctx[3] !== void 0) {
    audioinstance_props.stop = ctx[3];
  }
  audioinstance = new AudioInstance_default({
    props: audioinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(audioinstance, "inViewport", audioinstance_inViewport_binding, ctx[0]));
  binding_callbacks.push(() => bind(audioinstance, "play", audioinstance_play_binding, ctx[1]));
  binding_callbacks.push(() => bind(audioinstance, "pause", audioinstance_pause_binding, ctx[2]));
  binding_callbacks.push(() => bind(audioinstance, "stop", audioinstance_stop_binding, ctx[3]));
  audioinstance.$on("viewportenter", ctx[30]);
  audioinstance.$on("viewportleave", ctx[31]);
  audioinstance.$on("load", ctx[32]);
  audioinstance.$on("progress", ctx[33]);
  audioinstance.$on("error", ctx[34]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty[0] & 16)
        audioinstance_changes.position = ctx2[4];
      if (dirty[0] & 32)
        audioinstance_changes.scale = ctx2[5];
      if (dirty[0] & 64)
        audioinstance_changes.rotation = ctx2[6];
      if (dirty[0] & 128)
        audioinstance_changes.lookAt = ctx2[7];
      if (dirty[0] & 2048)
        audioinstance_changes.frustumCulled = ctx2[11];
      if (dirty[0] & 4096)
        audioinstance_changes.renderOrder = ctx2[12];
      if (dirty[0] & 8192)
        audioinstance_changes.visible = ctx2[13];
      if (dirty[0] & 16384)
        audioinstance_changes.userData = ctx2[14];
      if (dirty[0] & 32768)
        audioinstance_changes.dispose = ctx2[15];
      if (dirty[0] & 512)
        audioinstance_changes.castShadow = ctx2[9];
      if (dirty[0] & 1024)
        audioinstance_changes.receiveShadow = ctx2[10];
      if (dirty[0] & 256)
        audioinstance_changes.viewportAware = ctx2[8];
      if (dirty[0] & 65536)
        audioinstance_changes.autoplay = ctx2[16];
      if (dirty[0] & 262144)
        audioinstance_changes.source = ctx2[18];
      if (dirty[0] & 131072)
        audioinstance_changes.detune = ctx2[17];
      if (dirty[0] & 1048576)
        audioinstance_changes.loop = ctx2[20];
      if (dirty[0] & 2097152)
        audioinstance_changes.filters = ctx2[21];
      if (dirty[0] & 4194304)
        audioinstance_changes.playbackRate = ctx2[22];
      if (dirty[0] & 524288)
        audioinstance_changes.volume = ctx2[19];
      if (dirty[1] & 16) {
        audioinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty[0] & 1) {
        updating_inViewport = true;
        audioinstance_changes.inViewport = ctx2[0];
        add_flush_callback(() => updating_inViewport = false);
      }
      if (!updating_play && dirty[0] & 2) {
        updating_play = true;
        audioinstance_changes.play = ctx2[1];
        add_flush_callback(() => updating_play = false);
      }
      if (!updating_pause && dirty[0] & 4) {
        updating_pause = true;
        audioinstance_changes.pause = ctx2[2];
        add_flush_callback(() => updating_pause = false);
      }
      if (!updating_stop && dirty[0] & 8) {
        updating_stop = true;
        audioinstance_changes.stop = ctx2[3];
...
function create_fragment15(ctx) {
  ...
  binding_callbacks.push(() => bind(audioinstance, "pause", audioinstance_pause_binding, ctx[2]));
  binding_callbacks.push(() => bind(audioinstance, "stop", audioinstance_stop_binding, ctx[3]));
  audioinstance.$on("viewportenter", ctx[35]);
  audioinstance.$on("viewportleave", ctx[36]);
  audioinstance.$on("load", ctx[37]);
  audioinstance.$on("progress", ctx[38]);
  audioinstance.$on("error", ctx[39]);
  const block = {
    c: function create() {
      create_component(audioinstance.$$.fragment);
    },
...
function create_if_block2(ctx) {
  ...
  let current;
  object3dinstance = new Object3DInstance_default({
    props: { dispose: true, object: ctx[0] },
    $$inline: true
  });
  const block = {
    c: function create() {
...
function create_fragment17(ctx) {
  ...
  transformableobject.$on("transform", ctx[5]);
  const block = {
    c: function create() {
      create_component(disposableobject.$$.fragment);
      t = space();
    ...
    p: function update(ctx2, dirty) {
      const disposableobject_changes = {};
      if (dirty[0] & 4)
        disposableobject_changes.dispose = ctx2[2];
      if (dirty[0] & 1)
        disposableobject_changes.object = ctx2[0];
      disposableobject.$set(disposableobject_changes);
      const transformableobject_changes = {};
      if (dirty[0] & 2)
        transformableobject_changes.position = ctx2[1];
      transformableobject.$set(transformableobject_changes);
    },
    i: function intro(local) {
      if (current)
...
function create_fragment18(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const disposableobject_changes = {};
      if (dirty & 1)
        disposableobject_changes.dispose = ctx2[0];
      if (dirty & 2)
        disposableobject_changes.object = ctx2[1];
      disposableobject.$set(disposableobject_changes);
      const layerableobject_changes = {};
...
function create_fragment21(ctx) {
  ...
  if (ctx[0] !== void 0) {
    lightinstance_props.inViewport = ctx[0];
  }
  lightinstance = new LightInstance_default({
    props: lightinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(lightinstance, "inViewport", lightinstance_inViewport_binding, ctx[0]));
  lightinstance.$on("viewportenter", ctx[18]);
  lightinstance.$on("viewportleave", ctx[19]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 16)
        lightinstance_changes.lookAt = ctx2[4];
      if (dirty & 2)
        lightinstance_changes.position = ctx2[1];
      if (dirty & 4)
        lightinstance_changes.scale = ctx2[2];
      if (dirty & 8)
        lightinstance_changes.rotation = ctx2[3];
      if (dirty & 32)
        lightinstance_changes.castShadow = ctx2[5];
      if (dirty & 64)
        lightinstance_changes.receiveShadow = ctx2[6];
      if (dirty & 128)
        lightinstance_changes.frustumCulled = ctx2[7];
      if (dirty & 256)
        lightinstance_changes.renderOrder = ctx2[8];
      if (dirty & 512)
        lightinstance_changes.visible = ctx2[9];
      if (dirty & 1024)
        lightinstance_changes.userData = ctx2[10];
      if (dirty & 2048)
        lightinstance_changes.dispose = ctx2[11];
      if (dirty & 4096)
        lightinstance_changes.viewportAware = ctx2[12];
      if (dirty & 8192)
        lightinstance_changes.color = ctx2[13];
      if (dirty & 16384)
        lightinstance_changes.intensity = ctx2[14];
      if (dirty & 1048576) {
        lightinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty & 1) {
        updating_inViewport = true;
        lightinstance_changes.inViewport = ctx2[0];
        add_flush_callback(() => updating_inViewport = false);
      }
...
function create_if_block3(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const transformableobject_changes = {};
      if (dirty & 32768)
        transformableobject_changes.position = ctx2[15];
      transformableobject.$set(transformableobject_changes);
      const disposableobject_changes = {};
      if (dirty & 1024)
        disposableobject_changes.dispose = ctx2[10];
      if (dirty & 32768)
        disposableobject_changes.object = ctx2[15];
      disposableobject.$set(disposableobject_changes);
    },
    i: function intro(local) {
      if (current)
...
function create_fragment22(ctx) {
  ...
  let updating_inViewport;
  let current;
  let if_block = ctx[15] && !(ctx[15] instanceof Object3D) && create_if_block3(ctx);
  function lightinstance_inViewport_binding(value) {
    ctx[19](value);
  }
  let lightinstance_props = {
  ...
  binding_callbacks.push(() => bind(lightinstance, "inViewport", lightinstance_inViewport_binding, ctx[0]));
  lightinstance.$on("viewportenter", ctx[20]);
  lightinstance.$on("viewportleave", ctx[21]);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
    ...
    p: function update(ctx2, [dirty]) {
      if (ctx2[15] && !(ctx2[15] instanceof Object3D)) {
        if (if_block) {
          if_block.p(ctx2, dirty);
          if (dirty & 32768) {
            transition_in(if_block, 1);
      ...
      const lightinstance_changes = {};
      if (dirty & 2)
        lightinstance_changes.light = ctx2[1];
      if (dirty & 4)
        lightinstance_changes.position = ctx2[2];
      if (dirty & 8)
        lightinstance_changes.scale = ctx2[3];
      if (dirty & 16)
        lightinstance_changes.rotation = ctx2[4];
      if (dirty & 16384)
        lightinstance_changes.castShadow = ctx2[14] ? true : false;
      if (dirty & 32)
        lightinstance_changes.receiveShadow = ctx2[5];
      if (dirty & 64)
        lightinstance_changes.frustumCulled = ctx2[6];
      if (dirty & 128)
        lightinstance_changes.renderOrder = ctx2[7];
      if (dirty & 256)
        lightinstance_changes.visible = ctx2[8];
      if (dirty & 512)
        lightinstance_changes.userData = ctx2[9];
      if (dirty & 1024)
        lightinstance_changes.dispose = ctx2[10];
      if (dirty & 2048)
        lightinstance_changes.viewportAware = ctx2[11];
      if (dirty & 4096)
        lightinstance_changes.color = ctx2[12];
      if (dirty & 8192)
        lightinstance_changes.intensity = ctx2[13];
      if (dirty & 4194304) {
        lightinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty & 1) {
...
function create_fragment23(ctx) {
  ...
  if (ctx[1] !== void 0) {
    lightinstance_props.inViewport = ctx[1];
  }
  lightinstance = new LightInstance_default({
    props: lightinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(lightinstance, "inViewport", lightinstance_inViewport_binding, ctx[1]));
  lightinstance.$on("viewportenter", ctx[21]);
  lightinstance.$on("viewportleave", ctx[22]);
  const block = {
    c: function create() {
      create_component(lightinstance.$$.fragment);
    },
    ...
    p: function update(ctx2, [dirty]) {
      const lightinstance_changes = {};
      if (dirty & 1)
        lightinstance_changes.light = ctx2[0];
      if (dirty & 32)
        lightinstance_changes.lookAt = ctx2[5];
      if (dirty & 4)
        lightinstance_changes.position = ctx2[2];
      if (dirty & 8)
        lightinstance_changes.scale = ctx2[3];
      if (dirty & 16)
        lightinstance_changes.rotation = ctx2[4];
      if (dirty & 32768)
        lightinstance_changes.castShadow = ctx2[15] ? true : false;
      if (dirty & 64)
        lightinstance_changes.receiveShadow = ctx2[6];
      if (dirty & 256)
        lightinstance_changes.frustumCulled = ctx2[8];
      if (dirty & 512)
        lightinstance_changes.renderOrder = ctx2[9];
      if (dirty & 1024)
        lightinstance_changes.visible = ctx2[10];
      if (dirty & 2048)
        lightinstance_changes.userData = ctx2[11];
      if (dirty & 4096)
        lightinstance_changes.dispose = ctx2[12];
      if (dirty & 128)
        lightinstance_changes.viewportAware = ctx2[7];
      if (dirty & 16384)
        lightinstance_changes.color = ctx2[14];
      if (dirty & 8192)
        lightinstance_changes.intensity = ctx2[13];
      if (dirty & 8388608) {
        lightinstance_changes.$$scope = { dirty, ctx: ctx2 };
      ...
      if (!updating_inViewport && dirty & 2) {
        updating_inViewport = true;
        lightinstance_changes.inViewport = ctx2[1];
        add_flush_callback(() => updating_inViewport = false);
      }
      lightinstance.$set(lightinstance_changes);
    },
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 16)
        lightinstance_changes.rotation = ctx2[4];
      if (dirty & 64)
        lightinstance_changes.castShadow = ctx2[6];
      if (dirty & 128)
        lightinstance_changes.receiveShadow = ctx2[7];
      if (dirty & 512)
        lightinstance_changes.frustumCulled = ctx2[9];
      if (dirty & 1024)
        lightinstance_changes.renderOrder = ctx2[10];
      if (dirty & 2048)
        lightinstance_changes.visible = ctx2[11];
      if (dirty & 4096)
        lightinstance_changes.userData = ctx2[12];
      if (dirty & 8192)
        lightinstance_changes.dispose = ctx2[13];
      if (dirty & 256)
        lightinstance_changes.viewportAware = ctx2[8];
      if (dirty & 32768)
        lightinstance_changes.color = ctx2[15];
      if (dirty & 16384)
        lightinstance_changes.intensity = ctx2[14];
      if (dirty & 8388608) {
        lightinstance_changes.$$scope = { dirty, ctx: ctx2 };
...
function create_if_block4(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const transformableobject_changes = {};
      if (dirty[0] & 16384)
        transformableobject_changes.position = ctx2[14];
      transformableobject.$set(transformableobject_changes);
    },
    i: function intro(local) {
      if (current)
...
function create_fragment25(ctx) {
  ...
  let updating_inViewport;
  let current;
  let if_block = ctx[14] && !(ctx[14] instanceof Object3D) && create_if_block4(ctx);
  function lightinstance_inViewport_binding(value) {
    ctx[24](value);
  }
  let lightinstance_props = {
  ...
  binding_callbacks.push(() => bind(lightinstance, "inViewport", lightinstance_inViewport_binding, ctx[0]));
  lightinstance.$on("viewportenter", ctx[25]);
  lightinstance.$on("viewportleave", ctx[26]);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
    ...
    p: function update(ctx2, dirty) {
      if (ctx2[14] && !(ctx2[14] instanceof Object3D)) {
        if (if_block) {
          if_block.p(ctx2, dirty);
          if (dirty[0] & 16384) {
            transition_in(if_block, 1);
      ...
      if (dirty[0] & 2048)
        lightinstance_changes.dispose = ctx2[11];
      if (dirty[0] & 32)
        lightinstance_changes.viewportAware = ctx2[5];
      if (dirty[0] & 4096)
        lightinstance_changes.color = ctx2[12];
      if (dirty[0] & 8192)
        lightinstance_changes.intensity = ctx2[13];
...
function create_fragment31(ctx) {
  ...
  binding_callbacks.push(() => bind(object3dinstance, "inViewport", object3dinstance_inViewport_binding, ctx[0]));
  object3dinstance.$on("viewportenter", ctx[18]);
  object3dinstance.$on("viewportleave", ctx[19]);
  ...
  interactiveobject.$on("click", ctx[20]);
  interactiveobject.$on("contextmenu", ctx[21]);
  interactiveobject.$on("pointerup", ctx[22]);
  interactiveobject.$on("pointerdown", ctx[23]);
  interactiveobject.$on("pointerenter", ctx[24]);
  interactiveobject.$on("pointerleave", ctx[25]);
  interactiveobject.$on("pointermove", ctx[26]);
  const block = {
    c: function create() {
      create_component(object3dinstance.$$.fragment);
      t = space();
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & 2)
        interactiveobject_changes.object = ctx2[1];
      if (dirty & 16384)
        interactiveobject_changes.interactive = ctx2[14];
      if (dirty & 32768)
...
function create_fragment32(ctx) {
  ...
  meshinstance.$on("click", ctx[22]);
  meshinstance.$on("contextmenu", ctx[23]);
  meshinstance.$on("pointerup", ctx[24]);
  meshinstance.$on("pointerdown", ctx[25]);
  meshinstance.$on("pointerenter", ctx[26]);
  meshinstance.$on("pointerleave", ctx[27]);
  meshinstance.$on("pointermove", ctx[28]);
  meshinstance.$on("viewportenter", ctx[29]);
  meshinstance.$on("viewportleave", ctx[30]);
  const block = {
    c: function create() {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty[0] & 2048)
        disposableobject0_changes.dispose = ctx2[11];
      if (dirty[0] & 32768)
        disposableobject0_changes.object = ctx2[15];
      disposableobject0.$set(disposableobject0_changes);
      const disposableobject1_changes = {};
      if (dirty[0] & 2048)
        disposableobject1_changes.dispose = ctx2[11];
      if (dirty[0] & 65536)
        disposableobject1_changes.object = ctx2[16];
...
function create_key_block(ctx) {
  ...
  binding_callbacks.push(() => bind(meshinstance, "inViewport", meshinstance_inViewport_binding, ctx[0]));
  meshinstance.$on("click", ctx[20]);
  meshinstance.$on("contextmenu", ctx[20]);
  meshinstance.$on("pointerup", ctx[20]);
  meshinstance.$on("pointerdown", ctx[20]);
  meshinstance.$on("pointerenter", ctx[20]);
  meshinstance.$on("pointerleave", ctx[20]);
  meshinstance.$on("pointermove", ctx[20]);
  meshinstance.$on("viewportenter", ctx[25]);
  meshinstance.$on("viewportleave", ctx[26]);
  const block = {
    c: function create() {
      create_component(meshinstance.$$.fragment);
    },
    ...
    p: function update(ctx2, dirty) {
      const meshinstance_changes = {};
      if (dirty[0] & 131072)
        meshinstance_changes.mesh = ctx2[17];
      if (dirty[0] & 32)
        meshinstance_changes.castShadow = ctx2[5];
      if (dirty[0] & 64)
        meshinstance_changes.receiveShadow = ctx2[6];
      if (dirty[0] & 128)
        meshinstance_changes.renderOrder = ctx2[7];
      if (dirty[0] & 256)
        meshinstance_changes.visible = ctx2[8];
      if (dirty[0] & 512)
        meshinstance_changes.userData = ctx2[9];
      if (dirty[0] & 1024)
        meshinstance_changes.dispose = ctx2[10];
      if (dirty[0] & 2048)
        meshinstance_changes.interactive = ctx2[11];
      if (dirty[0] & 4096)
        meshinstance_changes.ignorePointer = ctx2[12];
      if (dirty[0] & 16)
        meshinstance_changes.viewportAware = ctx2[4];
      if (!updating_inViewport && dirty[0] & 1) {
        updating_inViewport = true;
...
function create_default_slot19(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      if (dirty[0] & 131072 && safe_not_equal(previous_key, previous_key = ctx2[17].uuid)) {
        group_outros();
...
function create_fragment33(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const disposableobject0_changes = {};
      if (dirty[0] & 1024)
        disposableobject0_changes.dispose = ctx2[10];
      if (dirty[0] & 16384)
        disposableobject0_changes.object = ctx2[14];
      disposableobject0.$set(disposableobject0_changes);
      const disposableobject1_changes = {};
      if (dirty[0] & 1024)
        disposableobject1_changes.dispose = ctx2[10];
      if (dirty[0] & 32768)
      ...
      if (dirty[0] & 8)
        object3dinstance_changes.rotation = ctx2[3];
      if (dirty[0] & 8192)
        object3dinstance_changes.lookAt = ctx2[13];
      if (dirty[0] & 134356977) {
        object3dinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      object3dinstance.$set(object3dinstance_changes);
    },
...
function create_fragment34(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      const transformableobject_changes = {};
      if (dirty & 1)
        transformableobject_changes.position = ctx2[0];
      if (dirty & 2)
        transformableobject_changes.scale = ctx2[1];
      if (dirty & 4)
        transformableobject_changes.rotation = ctx2[2];
      if (dirty & 8)
        transformableobject_changes.lookAt = ctx2[3];
      transformableobject.$set(transformableobject_changes);
    },
    i: function intro(local) {
      if (current)
...
function create_fragment35(ctx) {
  ...
  binding_callbacks.push(() => bind(object3dinstance, "inViewport", object3dinstance_inViewport_binding, ctx[0]));
  object3dinstance.$on("viewportenter", ctx[16]);
  object3dinstance.$on("viewportleave", ctx[17]);
  const block = {
    c: function create() {
      create_component(object3dinstance.$$.fragment);
    },
...
function create_fragment38(ctx) {
  ...
  if (ctx[0] !== void 0) {
    lineinstance_props.inViewport = ctx[0];
  }
  lineinstance = new LineInstance_default({
    props: lineinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(lineinstance, "inViewport", lineinstance_inViewport_binding, ctx[0]));
  lineinstance.$on("click", ctx[25]);
  lineinstance.$on("contextmenu", ctx[26]);
  lineinstance.$on("pointerup", ctx[27]);
  lineinstance.$on("pointerdown", ctx[28]);
  lineinstance.$on("pointerenter", ctx[29]);
  lineinstance.$on("pointerleave", ctx[30]);
  lineinstance.$on("pointermove", ctx[31]);
  lineinstance.$on("viewportenter", ctx[32]);
  lineinstance.$on("viewportleave", ctx[33]);
  const block = {
    c: function create() {
      create_component(disposableobject0.$$.fragment);
      t0 = space();
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty[0] & 2)
        lineinstance_changes.position = ctx2[1];
      if (dirty[0] & 4)
        lineinstance_changes.scale = ctx2[2];
      if (dirty[0] & 8)
        lineinstance_changes.rotation = ctx2[3];
      if (dirty[0] & 16384)
        lineinstance_changes.lookAt = ctx2[14];
      if (dirty[0] & 32)
        lineinstance_changes.castShadow = ctx2[5];
      if (dirty[0] & 64)
        lineinstance_changes.receiveShadow = ctx2[6];
      if (dirty[0] & 128)
        lineinstance_changes.frustumCulled = ctx2[7];
      if (dirty[0] & 256)
        lineinstance_changes.renderOrder = ctx2[8];
      if (dirty[0] & 512)
        lineinstance_changes.visible = ctx2[9];
      if (dirty[0] & 1024)
        lineinstance_changes.userData = ctx2[10];
      if (dirty[0] & 2048)
        lineinstance_changes.dispose = ctx2[11];
      if (dirty[0] & 4096)
        lineinstance_changes.interactive = ctx2[12];
      if (dirty[0] & 8192)
        lineinstance_changes.ignorePointer = ctx2[13];
      if (dirty[0] & 16)
        lineinstance_changes.viewportAware = ctx2[4];
      if (dirty[1] & 8) {
        lineinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty[0] & 1) {
        updating_inViewport = true;
        lineinstance_changes.inViewport = ctx2[0];
        add_flush_callback(() => updating_inViewport = false);
      }
...
function create_fragment39(ctx) {
  ...
  let meshinstance_props = {
    ...
    dispose: ctx[12],
    interactive: ctx[13],
    ignorePointer: ctx[14],
    viewportAware: ctx[5],
    $$slots: { default: [create_default_slot25] },
    $$scope: { ctx }
  };
  if (ctx[1] !== void 0) {
    meshinstance_props.inViewport = ctx[1];
  }
  meshinstance = new MeshInstance_default({
    props: meshinstance_props,
    $$inline: true
  });
  binding_callbacks.push(() => bind(meshinstance, "inViewport", meshinstance_inViewport_binding, ctx[1]));
  meshinstance.$on("click", ctx[23]);
  meshinstance.$on("contextmenu", ctx[24]);
  meshinstance.$on("pointerup", ctx[25]);
  meshinstance.$on("pointerdown", ctx[26]);
  meshinstance.$on("pointerenter", ctx[27]);
  meshinstance.$on("pointerleave", ctx[28]);
  meshinstance.$on("pointermove", ctx[29]);
  meshinstance.$on("viewportenter", ctx[30]);
  meshinstance.$on("viewportleave", ctx[31]);
  const block = {
    c: function create() {
      create_component(disposableobject0.$$.fragment);
      t0 = space();
    ...
    p: function update(ctx2, dirty) {
      const disposableobject0_changes = {};
      if (dirty[0] & 4096)
        disposableobject0_changes.dispose = ctx2[12];
      if (dirty[0] & 65536)
        disposableobject0_changes.object = ctx2[16];
      disposableobject0.$set(disposableobject0_changes);
      const meshinstance_changes = {};
      if (dirty[0] & 1)
        meshinstance_changes.mesh = ctx2[0];
      if (dirty[0] & 4)
        meshinstance_changes.position = ctx2[2];
      if (dirty[0] & 8)
        meshinstance_changes.scale = ctx2[3];
      if (dirty[0] & 16)
        meshinstance_changes.rotation = ctx2[4];
      if (dirty[0] & 32768)
        meshinstance_changes.lookAt = ctx2[15];
      if (dirty[0] & 64)
        meshinstance_changes.castShadow = ctx2[6];
      if (dirty[0] & 128)
        meshinstance_changes.receiveShadow = ctx2[7];
      if (dirty[0] & 256)
        meshinstance_changes.frustumCulled = ctx2[8];
      if (dirty[0] & 512)
        meshinstance_changes.renderOrder = ctx2[9];
      if (dirty[0] & 1024)
        meshinstance_changes.visible = ctx2[10];
      if (dirty[0] & 2048)
        meshinstance_changes.userData = ctx2[11];
      if (dirty[0] & 4096)
        meshinstance_changes.dispose = ctx2[12];
      if (dirty[0] & 8192)
        meshinstance_changes.interactive = ctx2[13];
      if (dirty[0] & 16384)
        meshinstance_changes.ignorePointer = ctx2[14];
      if (dirty[0] & 32)
        meshinstance_changes.viewportAware = ctx2[5];
      if (dirty[1] & 2) {
        meshinstance_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_inViewport && dirty[0] & 2) {
        updating_inViewport = true;
        meshinstance_changes.inViewport = ctx2[1];
        add_flush_callback(() => updating_inViewport = false);
      }
      meshinstance.$set(meshinstance_changes);
    },
...
function create_fragment40(ctx) {
  ...
  binding_callbacks.push(() => bind(lineinstance, "inViewport", lineinstance_inViewport_binding, ctx[0]));
  lineinstance.$on("click", ctx[22]);
  lineinstance.$on("contextmenu", ctx[23]);
  lineinstance.$on("pointerup", ctx[24]);
  lineinstance.$on("pointerdown", ctx[25]);
  lineinstance.$on("pointerenter", ctx[26]);
  lineinstance.$on("pointerleave", ctx[27]);
  lineinstance.$on("pointermove", ctx[28]);
  lineinstance.$on("viewportenter", ctx[29]);
  lineinstance.$on("viewportleave", ctx[30]);
  const block = {
    c: function create() {
      create_component(disposableobject0.$$.fragment);
      t0 = space();
...
var get_default_slot_changes_1 = (dirty) => ({ ref: dirty & 1 });
var get_default_slot_context_1 = (ctx) => ({ ref: ctx[0] });
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & 1)
        disposableobject_changes.object = ctx2[0];
      if (dirty & 2)
        disposableobject_changes.dispose = ctx2[1];
      disposableobject.$set(disposableobject_changes);
    },
    i: function intro(local) {
      if (current)
...
function create_else_block(ctx) {
  ...
  const default_slot = create_slot(default_slot_template, ctx, ctx[13], get_default_slot_context_1);
  const block = {
    c: function create() {
      if (default_slot)
        default_slot.c();
    ...
    p: function update(ctx2, dirty) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 8193)) {
          update_slot_base(
            default_slot,
            default_slot_template,
            ctx2,
            ctx2[13],
            !current ? get_all_dirty_from_scope(ctx2[13]) : get_slot_changes(default_slot_template, ctx2[13], dirty, get_default_slot_changes_1),
...
function create_if_block5(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const scenegraphobject_changes = {};
      if (dirty & 1)
        scenegraphobject_changes.object = ctx2[0];
      if (dirty & 8193) {
        scenegraphobject_changes.$$scope = { dirty, ctx: ctx2 };
      }
      scenegraphobject.$set(scenegraphobject_changes);
...
//# sourceMappingURL=chunk-2AJ3KWWH.js.map
